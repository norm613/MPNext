...
// Needs the Node.js runtime (Buffer / File / server-side fetch to Twilio).
 ...
 * incident (reliability principle).
 */
export async function POST(req: NextRequest) {
  ...
  // Resolve caller -> Contact. EMERGENCY_TEST_CONTACT_ID pins every incident to
  // one contact during development (e.g. 3575) so no real parishioner is
